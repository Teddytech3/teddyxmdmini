...
const buildCaption = (type, video) => {
  const banner = type === "video" ? `🎬 TEDDY-XMD VIDEO PLAYER` : `🎶 TEDDY-XMD PLAYER`;
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        externalAdReply: {
            ...
            mediaType: 1,
            sourceUrl: "https://whatsapp.com/channel/0029Vb6NveDBPzjPa4vIRt3n", // View Channel link
