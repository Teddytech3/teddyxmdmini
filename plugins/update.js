// plugins/update.js
const { cmd } = require("../inconnuboy"); // keeps your style consistent
...
async (conn, mek, m, { from, quoted, q, react, reply, isSuperUser, isOwner, setCommitHash, getCommitHash }) => {
  try {
    ...
    const repoOwner = "Teddytech3";
    const repoName = "teddyxmdmini";
    const branch = "main";
    ...
    // ----- OVERRIDE DISPLAY -----
    const authorName = "Teddy";          // always show popkid
    const authorEmail = "imteddytech@hotmail.com"; // masked email
