...
module.exports = {
    ...
    OWNER_NAME: process.env.OWNER_NAME || 'Teddy', // ADDED: For Owner button
    BOT_NAME: "TEDDY-XMD",
    ...
    GROUP_LINK: process.env.GROUP_LINK || 'https://chat.whatsapp.com/CLClgqJIC59GrcI4sRzLu8', // ADDED: For Group button
